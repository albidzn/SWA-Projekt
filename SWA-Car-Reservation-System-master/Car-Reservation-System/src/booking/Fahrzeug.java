...
public class Fahrzeug {
    ...
    // Methode, um alle Details des Fahrzeugs als String zurückzugeben
    public String getDetails() {
        return "Kategorie: " + kategorie + ", Modell: " + modell + ", Automatik: " + (automatik ? "Ja" : "Nein") +
               ", Klimaanlage: " + (klimaanlage ? "Ja" : "Nein") + ", Navigationssystem: " + (navigationssystem ? "Ja" : "Nein");
    }
}
